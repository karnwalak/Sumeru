                ...
                <div class="login-form text-center text-white p-7 position-relative overflow-hidden">
                    ...
                    <div class="login-signin">
                        <div class="mb-20">
                            ...
                            <p class="opacity-60 font-weight-bold">Enter your details to forgot password!</p>
                        </div>
                        <form id="form">
                            {{@csrf_field()}}
                            <div class="form-group">
                                <input
                                    ...
                                    type="text" placeholder="Enter Your Email" name="email" autocomplete="off" />
                                    <span style="color: red;" id="email_error" class="field_error"></span>
                            </div>
                            <div class="form-group d-flex flex-wrap justify-content-between align-items-center px-8">
                            <a href="/" class="text-light">Login Here!</a>
                            </div>
                            <div class="form-group text-center mt-10">
                                <!-- <input type="submit" value="Log In" name=""> -->
                                   <button type="submit" id="kt_login_signin_submit"
                                        class="btn btn-pill btn-outline-white font-weight-bold opacity-90 px-15 py-3">Send Email</button><br>
