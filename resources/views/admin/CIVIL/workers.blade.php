								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										...
										<div class="row" style="display:grid;place-items:end;padding:10px 15px;">
												<a href="../CIVIL/workers" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add a Worker</a>
												</div>
									</div>
									<!--end::Header-->
									<!--begin::Body-->
												...
												<table class="yajra">
													...
													<tbody class="datatable-body" style="">
														<tr data-row="1" class="datatable-row datatable-row-even" style="left: 0px;">
															...
															<td data-field="Sno" aria-label="" class="datatable-cell"><span style="width: 120px;"></span></td>
															<td data-field="Name" aria-label="" class="datatable-cell"><span style="width: 120px;"></span></td>
															<td data-field="Address" aria-label="" class="datatable-cell"><span style="width: 120px;"></span></td>
															<td data-field="Contact" aria-label="" class="datatable-cell"><span style="width: 120px;"></span></td>
															<td data-field="Email" aria-label="" class="datatable-cell"><span style="width: 120px;"></span></td>
