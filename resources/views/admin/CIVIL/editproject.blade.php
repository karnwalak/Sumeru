	...
	<form class="form" id="kt_form">
		...
		<div class="row justify-content-center d-flex py-5">
            <div class="card-title col-md-6">
                <h3 class="card-label">Edit Projects</h3>
            </div>
				...
				<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							...
							<input class="form-control form-control-solid form-control-lg" value="{{$data->project_name}}" name="project_name" type="text"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" value="{{$data->project_location}}" name="project_location" type="text"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<select name="state" class="form-control" id="state">
                                ...
                                @foreach($state as $st)
								   @if($data->project_state == $st->state)
								   <option value="{{$data->project_state}}" selected>{{$data->project_state}}</option>
								   @else
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<select name="city" class="form-control" id="city">
								...
								@foreach($city as $ci)
								   @if($data->project_city == $ci->city)
								   <option value="{{$data->project_city}}" selected>{{$data->project_city}}</option>
								   @else
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" value="{{$data->office_contact}}" name="contact" type="text"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" value="{{$data->project_budget}}" name="budget" type="text"/>
