	...
	<form class="form" id="kt_form">
		...
		<div class="row justify-content-center d-flex py-5">
            <div class="card-title col-md-6">
                <h3 class="card-label">Add Projects</h3>
            </div>
				...
				<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" name="project_name" type="text"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" name="project_location" type="text"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" name="budget" type="text"/>
