...
<!--begin::Title-->
<!-- <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Seller</h5> -->
<!--end::Title-->
<!--begin::Separator-->
...
<!-- <span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Enter new Seller and submit</span> -->
</div>
<!--end::Search Form-->
</div>
<!--end::Details-->
	...
	<form class="form" id="kt_form">
		...
		<div class="row justify-content-center d-flex py-5">
            <div class="card-title col-md-6">
                <h3 class="card-label">Project Detail</h3>
            </div>
            <div class="col-md-6" style="display:grid;place-items:end;padding:10px 15px;">
            <a href="../CIVIL/projects" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Back</a>
            </div>
        </div>
				...
				<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							...
							<input class="form-control form-control-solid form-control-lg" readonly value="{{$data->project_name}}" name="project_name" type="text"/>
							<span style="color:red;" id="project_name_error" class="field_error"></span>
						</div>
					</div>
					<!--end::Group-->
					<!--begin::Group-->
					<div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label">Project Location</label>
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" readonly value="{{$data->project_location}}" name="project_location" type="text"/>
							<span style="color:red;" id="project_location_error" class="field_error"></span>
						</div>
					</div>
					<!--end::Group-->
					<!--begin::Group-->
					<div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label">Project State</label>
						<div class="col-lg-9 col-xl-9">
                            <input type="text" class="form-control form-control-solid form-control-lg" readonly value="{{$data->project_state}}">
							<span style="color:red;" id="state_error" class="field_error"></span>
						</div>
					</div>
					<!--end::Group-->
                    <!--begin::Group-->
					<div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label">Project City</label>
						<div class="col-lg-9 col-xl-9">
                        <input type="text" class="form-control form-control-solid form-control-lg" readonly value="{{$data->project_city}}">
							<span style="color:red;" id="city_error" class="field_error"></span>
						</div>
					</div>
					<!--end::Group-->
					<!--begin::Group-->
					<div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label">Office Contact</label>
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" readonly value="{{$data->office_contact}}" name="contact" type="text"/>
                    ...
                    <!--begin::Group-->
					<div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label">Budget</label>
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" readonly value="{{$data->project_budget}}" name="budget" type="text"/>
							<span style="color:red;" id="budget_error" class="field_error"></span>
						</div>
					</div>
					<!--end::Group-->
					<!--begin::Group-->
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
                        <input type="text" class="form-control form-control-solid form-control-lg" readonly value="{{$data->project_status}}">
