								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Sellers</h3>
										</div>
														...
														<tr data-row="1" class="datatable-row datatable-row-even" style="left: 0px;">
															...
															<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																<span style="width: 100px;">
																	 <a href="sellerprofile/{{$value->id}}"><i class="fa fa-eye"></i></a>
																	 <a onclick="return confirm('Are you sure?')" href="sellerdelete/{{$value->id}}"><i class="fa fa-trash"></i></a>
																	 <a href="editsellers/{{$value->id}}"><i class="fa fa-pencil"></i></a>
																	 <a href="sellerpurchaseorder/{{$value->id}}"><i class="fa fa-shopping-cart"></i></a>
																</span>
															</td>
														</tr>
														@endforeach
