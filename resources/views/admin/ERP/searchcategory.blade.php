								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Search Result</h3><br>
										</div>
												...
												<table class="datatable-table" style="display: block;">
													...
													<tbody class="datatable-body" style="">
														...
														<tr data-row="0" class="datatable-row" style="left: 0px;">
															...
															<td data-field="category_parent" aria-label="{{$value -> category_parent}}" class="datatable-cell"><span style="width: 120px;">
															<?php 
														...
														@else
														<tr data-row="0" class="datatable-row" style="left: 0px;">
															<td colspan="6" style="text-align: center;" class="datatable-cell">
