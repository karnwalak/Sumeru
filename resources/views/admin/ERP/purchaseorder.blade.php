			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="row justify-content-center">
									...
									<div class="col-md-6 alert alert-primary alert-block alert-dismissible fade show">  
										<span>{{ $message }}</span>
									...
									<div class="col-md-6 alert alert-danger alert-block alert-dismissible fade show">  
									<span>{{ $message }}</span>  
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Purchase Order</h3>
										</div>
														...
														<div class="row align-items-center">
															<div class="col-md-4 my-2 my-md-0">
																<div class="input-icon">
																	<input type="text" class="form-control" placeholder="Search..." name="invoice" id="kt_datatable_search_query">
																	<span>
													...
													<tbody class="datatable-body" style="">
														...
														<tr data-row="0" class="datatable-row" style="left: 0px;">
															...
															<td data-field="SellerName" aria-label="{{$value -> seller_id}}" class="datatable-cell"><span style="width: 100px;">
																<?php 
																$id = $value -> seller_id;
                                                                $result = DB::SELECT("SELECT * FROM sellers WHERE id = $id");
								                               ...
								                               @else
								                                <div class="form-check form-switch">
																  <input class="form-check-input statuschange" name="status" type="checkbox" id="{{$value -> id}}"/>
                               									...
                               									@endif -->
                               									<span style="width: 100px;">{{$value -> order_status}}</span>
                               									
														  </td>
															<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																<span style="overflow: visible; position: relative; width: 125px;">
																<a href="../ERP/viewpurchaseorder/{{$value -> id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																...
																@if($value -> order_status == 'Recieved')
																<a onclick="return alert('Recieved order can not be edit!')" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																	<span class="svg-icon svg-icon-md">
																...
																@else
																<a href="../ERP/editpurchaseorder/{{$value -> id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																	<span class="svg-icon svg-icon-md">
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																				<rect x="0" y="0" width="24" height="24"></rect>
																...
																@endif
																<a href="../ERP/deleteorder/{{$value -> id}}" onclick="return confirm('Are you sure?');" class="btn btn-sm btn-clean btn-icon" title="Delete">
																	<span class="svg-icon svg-icon-md">
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																				<rect x="0" y="0" width="24" height="24"></rect>
