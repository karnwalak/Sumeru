		...
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="row" style="display:grid;place-items:end;margin:5px 20px">
					<!--begin::Button-->
					<a href="purchaseorderrequest" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a>
					<!--end::Button-->
				</div>
				<!--end::Toolbar-->
													...
													<form id="form">
														{{@csrf_field()}}
															...
															<div class="d-flex align-items-center justify-content-between py-5 pl-8 pr-5 border-bottom">
																	<h5 class="font-weight-bold m-0">Add Request</h5>
															</div>
															<!--end::Header-->
															<!--begin::Body-->
															<div class="d-block">
															...
															<div class="row" style="display: grid;place-items: end;margin: 25px;">
																...
																<div class="btn-group ml-2">
																	<button type="submit" class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base">Add Request</button>
																</div>
																<!--end::Dropdown-->
															</div>
													</form>
