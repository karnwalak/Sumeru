		...
		<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
			<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
				...
				<div class="d-flex align-items-center flex-wrap mr-2">
					<!--begin::Title-->
					<!-- <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Category</h5> -->
					<!--end::Title-->
					<!--begin::Separator-->
											...
											<form class="form" id="kt_form">
												...
												<div class="row justify-content-center d-flex py-5">
													<div class="card-title col-md-6">
														<h3 class="card-label">Edit Materials</h3>
													</div>
														...
														<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9 col-xl-9">
																	<input class="form-control form-control-solid form-control-lg" name="category_name" type="text" value="{{$value->category_name}}" />
																	<span style="color:red;" class="field_error" id="category_name_error"></span>
																</div>
															</div>
															<!--end::Group-->
<!-- begin::Group -->
<div class="form-group row" data-select2-id="243">
    ...
    ?>
	 ...
	 <script type="text/javascript">
      var pid = '<?php echo $value -> category_parent; ?>';
      // alert(pid);
      $(".selectdiv select").val(pid);
    </script>
	</div>
</div>
<!--end::Group-->
