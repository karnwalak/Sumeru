				...
				<!-- add header end -->
						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center">
									<!--begin::Button-->
									<!-- <a href="materialcategory.php" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a> -->
									<!--end::Button-->
								</div>
								<!--end::Toolbar-->
							</div>
...
<div class="col-xl-9">
	...
	<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
		...
		<div class="row justify-content-center d-flex py-5">
			<div class="card-title col-md-6">
				<h3 class="card-label">Add Products</h3>
			</div>
		...
		<div class="form-group row">
			...
			<div class="col-lg-9 col-xl-9">
				<input class="form-control form-control-solid form-control-lg" name="modal" type="text" value="" />
		...
		<div class="form-group row">
			...
			<div class="col-lg-9 col-xl-9">
				<input class="form-control form-control-solid form-control-lg" name="sku" type="text" value="" />
    ...
    ?>
		...
		<!-- begin::Group -->
		<div class="form-group row" data-select2-id="243">
			<label class="col-form-label text-left col-lg-3 col-sm-12">Release Type</label>
			<div class="col-lg-9 col-md-9 col-sm-12" data-select2-id="242">
				<select class="form-control" id="kt_select2_1" name="release_type">
					<option value="">Select</option>
					<option value="Combined">Combined</option>
					<option value="Single">Single</option>
				</select>
				<span style="color:red;" class="field_error" id="release_type_error"></span>
			</div>
		</div>
		<!--end::Group-->
		</div>
