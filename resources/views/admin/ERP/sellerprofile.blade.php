...
<div class="row" style="justify-content:end;">
												...
												<div class="row py-5">
															<div class="col-md-10">
															<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h2 mb-0">{{$value -> seller_name}}</a>
												...
												<div class="mb-7">
													<div class="d-flex justify-content-between align-items-center" style="margin:10px">
														...
														<a href="#" class="text-hover-primary">{{$value -> seller_email}}</a>
													</div>
													<div class="d-flex justify-content-between align-items-cente my-1" style="margin:10px">
														<span class="text-dark-75 font-weight-bolder mr-2">Phone:</span>
														<a href="#" class="text-hover-primary">{{$value -> seller_contact}}</a>
													</div>
													<div class="d-flex justify-content-between align-items-center" style="margin:10px"	>
														<span class="text-dark-75 font-weight-bolder mr-2">Address:</span>
														<span class="font-weight-bold">{{$value -> seller_address}}</span>
													</div>
												</div>
											</div>
											<!--end::Body-->
