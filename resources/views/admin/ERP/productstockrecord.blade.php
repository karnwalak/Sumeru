						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center">
									...
									<!--end::Button-->
									<!--begin::Button-->
									<!-- <a href="addproducts.php" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add Products</a> -->
									<!--end::Button-->
								</div>
								<!--end::Toolbar-->
							</div>
	...
	<div class="card card-custom gutter-b">
										<div class="card-body">
											...
											<div class="mb-7">
												<div class="row align-items-center">
													...
													<div class="col-lg-3 col-xl-3">
														<div class="form-group row">
															<label class="col-xl-6 col-lg-6 col-form-label" style="padding-top:0px !important;">Current Stock : </label>
												...
												<form method="post" action="../ERP/searchstock">
												{{@csrf_field()}}
												<div class="row align-items-center">
															...
															<div class="col-md-4 my-2 my-md-0">
																<div class="row">
																	...
																	<div class="col-lg-8 col-md-8	 col-sm-12" data-select2-id="242">
																		...
																		@foreach($data as $li)
																		<option value="{{$li -> stock_type}}">{{$li -> stock_type}}</option>
																		@endforeach
																		</select>
																	</div>
																</div>
												...
												<table class="datatable-table" style="display: block;">
													<thead class="datatable-head">
														<tr class="datatable-row" style="left: 0px;">
															...
															<th data-field="Date" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Date</span></th>
															<th data-field="Comment" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Comment</span></th>
															<th data-field="Buyer/Seller" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Buyer/Seller</span></th>
															<th data-field="Cost/Item" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Cost/Item</span></th>
														</tr>
													</thead>
