	...
	<form class="form" id="kt_form">
		...
		<div class="row justify-content-center d-flex py-5">
			<div class="card-title col-md-6">
				<h3 class="card-label">Edit Seller</h3>
			</div>
			<div class="col-md-6" style="display:grid;place-items:end;padding:10px 15px;">
			<a href="../ERP/seller" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Back</a>
			</div>
		</div>
		<div class="row justify-content-center">
			<div class="col-xl-9">
				...
				<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
					...
					<!--begin::Group-->
					<input type="hidden" value="{{$value -> id}}" name="seller_id">
					<div class="form-group row">
						<label class="col-xl-3 col-lg-3 col-form-label">Name</label>
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" value="{{$value -> seller_name}}" name="name" type="text"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" value="{{$value -> seller_contact}}" name="contact" type="text"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" value="{{$value -> seller_email}}" name="email" type="text"/>
					...
					<div class="form-group row">
						...
						<div class="col-lg-9 col-xl-9">
							<input class="form-control form-control-solid form-control-lg" value="{{$value -> seller_address}}" name="address" type="text"/>
