                            ...
                            <div class="card card-custom">
                                ...
                                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                                    <div class="card-title">
                                        <h3 class="card-label">Purchase Order Requests
                                    ...
                                    <div class="card-toolbar">
                                        <!--begin::Button-->
                                        <a href="#">
                                            <a href="addrequest" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Create Request</a>
                                        </a>
                                        <!--end::Button-->
                                    </div>
                                </div>
                                        ...
                                        <table class="datatable-table" style="display: block;">
                                            <thead class="datatable-head">
                                                <tr class="datatable-row" style="left: 0px;">
                                                    ...
                                                    <th data-field="EmployeeName" class="datatable-cell datatable-cell-sort"><span style="width: 170px;">Employee Name</span></th>
                                                    <th data-field="EmployeeContact" class="datatable-cell datatable-cell-sort" data-sort="asc"><span style="width: 140px;">Employee Contact</span></th>
                                                    ...
                                                    <th data-field="Status" class="datatable-cell datatable-cell-sort"><span style="width: 110px;">Status</span></th>
