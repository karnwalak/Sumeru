...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="d-flex flex-row flex-column-fluid page">
						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<!-- <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Category</h5> -->
									<!--end::Title-->
									<!--begin::Separator-->
									...
									<!-- <div class="d-flex align-items-center" id="kt_subheader_search">
										<span class="text-dark-50 font-weight-bold" id="kt_subheader_total">Edit the category and submit</span>
									</div> -->
									<!--end::Search Form-->
								</div>
								<!--end::Details-->
								...
								<div class="d-flex align-items-center">
									<!--begin::Button-->
									<!-- <a href="materialspage.php" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a> -->
									<!--end::Button-->
								</div>
								<!--end::Toolbar-->
							</div>
			...
			<div class="col-lg-9 col-xl-9">
				...
				<input class="form-control form-control-solid form-control-lg" name="name" type="text" value="{{$value -> material_name}}" />
		...
		<!--begin::Group-->
		<div class="form-group row">
			<label class="col-xl-3 col-lg-3 col-form-label">Modal</label>
			<div class="col-lg-9 col-xl-9">
				<input class="form-control form-control-solid form-control-lg" name="modal" type="text" value="{{$value -> modal}}" />
				<span style="color:red;" class="field_error" id="modal_error"></span>
			</div>
		</div>
		<!--end::Group-->
		<!--begin::Group-->
		<div class="form-group row">
			...
			<div class="col-lg-9 col-xl-9">
				<input class="form-control form-control-solid form-control-lg" name="sku" type="text" value="{{$value -> sku}}" />
				<span style="color:red;" class="field_error" id="sku_error"></span>
			</div>
		</div>
		<!--end::Group-->
		<!-- begin::Group -->
		<div class="form-group row" data-select2-id="243">
			<label class="col-form-label text-left col-lg-3 col-sm-12">Category</label>
    ...
    ?>
			...
			<option value="">Select</option>
			 <?php 
                 ...
                 foreach($datas as $val){
                  ...
                  ?>
                  <option value="<?php echo $rowid; ?>" selected><?php echo $category; ?></option>
                  <?php
		...
		<!-- begin::Group -->
		<div class="form-group row" data-select2-id="243">
			<label class="col-form-label text-left col-lg-3 col-sm-12">Type</label>
			<div class="col-lg-9 col-md-9 col-sm-12" data-select2-id="242">
				<select class="form-control" id="kt_select2_1" name="type">
					...
					<option value="BORIES">BORIES</option>
				</select>
				<span style="color:red;" class="field_error" id="type_error"></span>
			</div>
		</div>
		<!--end::Group-->
		<!-- begin::Group -->
		...
		<div class="col-lg-9 col-xl-9">
			<select  class="form-control form-control-solid form-control-lg" name="release_type">
				<option value="">Select</option>
				@if($value->release_type =='Combined')
			...
			<span style="color:red;" id="release_type_error" class="field_error"></span>
		</div>
	</div>
<!--end::Group-->
																		</div>
