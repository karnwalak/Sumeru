											...
											<div class="row" style="justify-content:center;">
													...
													<div class="card-header flex-wrap border-0 pt-6 pb-0">
															...
															<div class="card-toolbar">
																	<!--begin::Button-->
																	<a href="#">
																	<a href="createleads" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Create Lead</a>
																	</a>
																	<!--end::Button-->
															</div>
													</div>
														...
														<div class="row align-items-center">
															<div class="col-md-5 my-2 my-md-0">
																<div class="input-icon">
																	<input type="text" class="form-control" name="leadname" placeholder="Search..." id="kt_datatable_search_query">
																	<span>
															...
															<div class="col-md-7 my-2 my-md-0">
																<div class="row">
																	...
																	<div class="col-lg-8 col-md-8	 col-sm-12" data-select2-id="242">
																		<select class="form-control" id="kt_select2_1" name="leadstatus">
