							...
							<div class="d-flex flex-column-fluid">
									...
									@endif
											...
											<div class="d-flex align-items-center flex-wrap mr-2">
													<!--begin::Title-->
													<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5 pl-10 pt-5">Contacts</h5>
													<!--end::Title-->
													<!--begin::Separator-->
											...
											<!--end::Details-->
													<!-- <div class="row">
														<div class="col-md-3 col-6" style="padding:20px; display:grid;place-items:center;">
															<a href="employees.php" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Employees</a>
														</div>
														<div class="col-md-3 col-6" style="padding:20px; display:grid;place-items:center;">
															<a href="allowances.php" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Allowances</a>
														</div>
														<div class="col-md-3 col-6" style="padding:20px; display:grid;place-items:center;">
															<a href="addemployees.php" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add Employee</a>
														</div>
														<div class="col-md-3 col-6" style="padding:20px; display:grid;place-items:center;">
															<a href="addemployees.php" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add Employee</a>
														</div>
													...
													<div class="card-header flex-wrap border-0 pt-3 pb-1">
															...
															<div class="card-toolbar">
																	<!--begin::Button-->
																	<a href="#">
																	<a href="addcontacts" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add Contacts</a>
																	</a>
																	<!--end::Button-->
															</div>
													</div>
																	...
																	<table class="datatable-table" style="display: block;">
																			<thead class="datatable-head">
																					<tr class="datatable-row" style="left: 0px;">
																							...
																							<th data-field="Name" class="datatable-cell datatable-cell-sort"><span style="width: 250px;">Name</span></th>
																							<th data-field="Contact" class="datatable-cell datatable-cell-sort" data-sort="asc"><span style="width: 130px;">Contact</span></th>
																							<th data-field="Email" class="datatable-cell datatable-cell-sort"><span style="width: 130px;">Email</span></th>
																							<th data-field="City" class="datatable-cell datatable-cell-sort"><span style="width: 130px;">City</span></th>
																					...
																					<tr data-row="0" class="datatable-row" style="left: 0px;">
																							...
																							<td data-field="OrderID" aria-label="64616-103" class="datatable-cell">
																									<span style="width: 250px;">
																											<div class="d-flex align-items-center">
																													<div class="ml-4">
																															<div class="text-dark-75 font-weight-bolder font-size-lg mb-0">{{$value -> contact_full_name}}</div>
																							...
																							<td data-field="ShipDate" aria-label="10/15/2017" class="datatable-cell">
																									<span style="width: 130px;">
																											<div class="font-weight-bolder mb-0">{{$value -> contact_mob_no}}</div>
																											<!-- <div class="text-muted">Rejected</div> -->
																									</span>
																							</td>
																							<td data-field="ShipDate" aria-label="10/15/2017" class="datatable-cell">
																									<span style="width: 130px;">
																											<div class="font-weight-bolder mb-0">{{$value -> contact_email}}</div>
																											<!-- <div class="text-muted">Rejected</div> -->
																									</span>
																							</td>
																							<td data-field="CompanyName" aria-label="Casper-Kerluke" class="datatable-cell">
																									<span style="width: 130px;">
																											<div class="font-weight-bold ">{{$value -> contact_city}}</div>
																									</span>
																							</td>
																							<td data-field="Status" aria-label="5" class="datatable-cell">
																							<span style="width: 130px;">
																							@if($value -> contact_status == 'Active')
																							<button class="btn btn-success statuschange" id="{{$value -> id}}">{{$value -> contact_status}}</button>
																							@elseif($value -> contact_status == 'Inactive')
																							<button class="btn btn-danger statuschange" id="{{$value -> id}}">{{$value -> contact_status}}</button>
																							@endif
																							</span>
																							</td>
																							<td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
																									<span style="overflow: visible; position: relative; width: 130px;">
																									<a href="contactview/{{$value -> id}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
																											...
																											<a href="editcontacts/{{$value -> id}}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
																													<span class="svg-icon svg-icon-md">
																											...
																											<a href="deletecontact/{{$value -> id}}" onclick="return confirm('Are you sure!')" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon" title="Delete">
																													<span class="svg-icon svg-icon-md">
																															<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																																	<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																																			<rect x="0" y="0" width="24" height="24"></rect>
