																	...
																	<table class="datatable-table" style="display: block;">
																			...
																			<tbody style="" class="datatable-body">
																					<tr data-row="0" class="datatable-row" style="left: 0px;">
																							...
																							<td data-field="ShipDate" aria-label="10/15/2017" class="datatable-cell">
																									<span style="width: 130px;">
																											<div class="font-weight-bolder mb-0">abcd@email.com</div>
																											<!-- <div class="text-muted">Rejected</div> -->
																									</span>
																							</td>
																							<td data-field="CompanyName" aria-label="Casper-Kerluke" class="datatable-cell">
																									<span style="width: 130px;">
																											<div class="font-weight-bold ">1BHK Flat</div>
																									</span>
																							</td>
																							<td data-field="Status" aria-label="5" class="datatable-cell"><span style="width: 130px;"><input type="button" id="button" value="Status" style="color:white" onclick="setColor(event, 'button', '#101010')"; data-count="1" /></span></td>
																							<td data-field="Actions" data-autohide-disabled="false" aria-label="null" class="datatable-cell">
																									<span style="overflow: visible; position: relative; width: 130px;">
																									<a href="contactview" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
																											...
																											<a href="editcontacts" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2" title="Edit details">
																													<span class="svg-icon svg-icon-md">
