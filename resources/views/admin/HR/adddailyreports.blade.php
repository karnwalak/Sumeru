													...
													<form id="form" enctype="multipart/form-data">
														{{@csrf_field()}}
															...
															<div class="d-flex align-items-center justify-content-between py-5 pl-8 pr-5 border-bottom">
																	<h5 class="font-weight-bold m-0">Add Report</h5>
															</div>
															<!--end::Header-->
															<!--begin::Body-->
															<div class="d-block">
																	...
																	<div class="border-bottom">
																		<div class="d-flex align-items-center">
																			<input class="form-control border-0 px-8 min-h-45px" name="title" placeholder="What's on your mind.">
															...
															<div class="row" style="display: grid;place-items: end;margin: 25px;">
																...
																<div class="btn-group ml-2">
																	<button type="submit" class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base">Add Report</button>
																</div>
																<!--end::Dropdown-->
															</div>
													</form>
        ...
        $("#form").submit(function(e){
           ...
           $.ajax({
                ...
                success:function(result) {
                  ...
                  setTimeout(function(){
                   window.location.href = '../HR/dailyreports'; 
                 }, 1000);
                }   
                },
             complete:function(){
