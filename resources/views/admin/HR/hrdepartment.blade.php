														...
														<table class="datatable-table" style="display: block;">
															...
															<tbody class="datatable-body" style="">
																<tr data-row="0" class="datatable-row" style="left: 0px;">
																	...
																	<td data-field="Name" aria-label="Furniture" class="datatable-cell"><span style="width: 120px;">Furniture</span></td>
																	<td data-field="Parent" aria-label="None" class="datatable-cell"><span style="width: 120px;">None</span></td>
																	<td data-field="Lead" aria-label="Aakash" class="datatable-cell"><span style="width: 120px;">Aakash</span></td>
																	<td data-field="Status" aria-label="5" class="datatable-cell"><span style="width: 120px;"><input type="button" id="button" value="Status" style="color:white" onclick="setColor(event, 'button', '#101010')" ; data-count="1" /></span></td>
																	<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																		<span style="overflow: visible; position: relative; width: 125px;">
																			<a href="edithrdepartment" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
