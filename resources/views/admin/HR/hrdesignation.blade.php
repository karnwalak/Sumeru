								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										...
										<div class="row" style="display:grid;place-items:end;padding:10px 15px;">
												<a href="addhrdesignation" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add Designation</a>
												</div>
									</div>
									<!--end::Header-->
									<!--begin::Body-->
									<div class="card-body">
											...
											<div class="card card-custom gutter-b">
												<div class="card-body">
													<!--begin: Search Form-->
													<!--begin::Search Form-->
													<form action="searchdesignation" method="post">
													{{@csrf_field()}}
													<div class="mb-7">
															...
															@foreach($data as $value)
																<tr data-row="0" class="datatable-row datatable-row-even" style="left: 0px;">
																	...
																	<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																		...
																		<a href="edithrdesignation/{{$value -> id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																		...
																		<a href="deletehrdesignation/{{$value -> id}}" onclick="return confirm('Are you sure?')" class="btn btn-sm btn-clean btn-icon" title="Delete">
																			<span class="svg-icon svg-icon-md">
																				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																						<rect x="0" y="0" width="24" height="24"></rect>
		  ...
		  $(".statuschange").click(function () {
		    ...
		    $.ajax({
		      ...
		      success: function (data) {
                window.location.href = '../HR/hrdesignation'; 
		      }
		    });
		  });
		});
