													...
													<form id="form" enctype="multipart/form-data">
														{{@csrf_field()}}
															...
															<div class="d-flex align-items-center justify-content-between py-5 pl-8 pr-5 border-bottom">
																	<h5 class="font-weight-bold m-0">Edit Report</h5>
															</div>
															<!--end::Header-->
															<!--begin::Body-->
															<div class="d-block">
															...
															<div class="form-group row">
																...
																<div class="col-lg-9">
																	...
																	<a href="/../upload/{{$data -> doc_upload}}">View Uploaded File</a>
																</div>
															</div>
															<div class="row" style="display: grid;place-items: end;margin: 25px;">
																<!--begin::Dropdown-->
																<div class="btn-group ml-2">
																	<button type="submit" class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base">Update Report</button>
																</div>
																<!--end::Dropdown-->
															</div>
													</form>
