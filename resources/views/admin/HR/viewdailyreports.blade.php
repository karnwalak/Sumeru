		...
		<div class="d-flex flex-row flex-column-fluid page">
			...
			<div class="d-flex flex-column flex-row-fluid wrapper" id="kt_wrapper">
				...
				<div class="row" style="display:grid;place-items:end;margin:5px 20px">
					<!--begin::Button-->
					<a href="dailyreports" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a>
					<!--end::Button-->
				</div>
				<!--end::Toolbar-->
											...
											<div class="modal-content">
													...
													<form id="kt_inbox_compose_form">
															...
															<div class="d-flex align-items-center justify-content-between py-5 pl-8 pr-5 border-bottom">
																	<h5 class="font-weight-bold m-0">View Report</h5>
															</div>
															<!--end::Header-->
															<!--begin::Body-->
															<div class="d-block">
																		...
																		<div class="d-flex align-items-center px-10 py-10">
																			...
																			<div class="ml-4">
																					<div class="font-weight-bolder mb-0">{{$val -> employee_name}} (<?php 
																											...
																											echo $pval -> name;
																										?>)</div>
																					<div class=" mb-0">Employee ID : {{$val -> employee_id}}</div>				
																			</div>				
																					<div class="row" style="display: grid;place-items: end;margin: 15px;">
																							<a href="employeeprofile/{{$val -> employee_id}}" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">View Employee</a>
																					</div>
																			</div>
																	</div>
																	<div class="border-bottom">
																		<div class="d-flex align-items-center px-10 py-10">
																	   <textarea type="text" name="message" class="form-control border-0 px-8 min-h-45px" id="editor" placeholder="This is the Title" >{{$val -> title}}</textarea>
																		</div>
																	</div>
																	<div class="border-bottom">
																		<div class="d-flex align-items-center px-10 py-10">
																	   <textarea type="text" name="message" class="form-control border-0 px-8 min-h-45px" id="editor" placeholder="This is the Description" >{{strip_tags($val->description)}}</textarea>
																		</div>
																	</div>
																	<div class="form-group row px-10 py-10">
																		...
																		<div class="col-lg-9">
																					...
																					<!-- <a class="dropzone-select btn btn-light-primary font-weight-bold btn-sm dz-clickable">View files</a> -->
																					<a href="/../upload/{{$val -> doc_upload}}" class="dropzone-select btn btn-light-primary font-weight-bold btn-sm dz-clickable">View files</a>
																		</div>
																	</div>
																	<div>
																	<!--end::Subject-->
