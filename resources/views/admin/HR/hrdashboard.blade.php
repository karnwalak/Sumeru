							...
							<div class="container">
								...
								<div class="row">
									<div class="col-lg-4 col-12">
										<div class="card card-custom card-stretch gutter-b  scrollable">
											<!--begin::Header-->
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-dark">Birthday</h3>
											</div>
											<!--end::Header-->
											...
											<div class="card-body pt-2">
												...
												<div class="d-flex flex-wrap align-items-center mb-10">
													...
													<div class="d-flex flex-column flex-grow-1 my-lg-0 my-2 pr-3">
														<a href="#" class="text-dark-75 font-weight-bolder text-hover-primary font-size-lg">S9 - Cup &amp; Green</a>
														<span class="text-primary font-weight-bold"><i class="fa fa-mobile" aria-hidden="true"></i>&nbsp;098765432123</span></span>
														<span class="text-primary font-weight-bold"><i class="fa fa-phone" aria-hidden="true"></i>&nbsp;098</span></span>
													</div>
													<!--end::Title-->
												</div>
												<!--end::Item-->
									...
									<div class="col-lg-4 col-12">
										<div class="card card-custom card-stretch gutter-b scrollable">
											<!--begin::Header-->
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-dark">New Hires</h3>
											</div>
											<!--end::Header-->
											<hr style="margin-top:0rem;">
											<!--begin::Body-->
									...
									<div class="col-lg-4 col-12">
										<div class="card card-custom card-stretch gutter-b scrollable">
											<!--begin::Header-->
											<div class="card-header border-0">
												<h3 class="card-title font-weight-bolder text-dark">Favourites</h3>
											</div>
											<!--end::Header-->
											<hr style="margin-top:0rem;">
											<!--begin::Body-->
								...
								<div class="row">
									...
									<div class="col-xl-4 col-lg-6 col-md-6 col-sm-6">
										<!--begin::Card-->
										<div class="card card-custom gutter-b card-stretch scrollable">
											<!--begin::Body-->
												...
												<div class="d-flex align-items-end mb-7">
													...
													<div class="d-flex align-items-center">
														...
														<div class="d-flex flex-column">
															<span class="font-weight-bolder">Quick Links &nbsp; &nbsp; &nbsp;<i class="fa fa-plus-circle" aria-hidden="true" style="color:green;"></i></span>
														</div>
														<!--end::Title-->
													</div>
													<!--end::Title-->
											...
											<div class="card-body pt-4">
												...
												<div class="d-flex align-items-end mb-7">
													...
													<div class="d-flex align-items-center">
														<!--begin::Title-->
														<div class="d-flex flex-column">
															<span class="font-weight-bolder">Request For Approval</span>
														</div>
														<!--end::Title-->
													</div>
													<!--end::Title-->
											...
											<div class="card-body pt-4">
												...
												<div class="d-flex align-items-end mb-7">
													...
													<div class="d-flex align-items-center">
														<!--begin::Title-->
														<div class="d-flex flex-column">
															<span class="font-weight-bolder">Attendance &nbsp; &nbsp; &nbsp; <i class="fa fa-calendar" aria-hidden="true"></i></span>
														</div>
														<!--end::Title-->
													</div>
													<!--end::Title-->
