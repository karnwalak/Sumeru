                                        ...
                                        <table class="datatable-table" style="display: block;">
                                            ...
                                            <tbody style="" class="datatable-body">
																							<tr data-row="0" class="datatable-row" style="left: 0px;">
																								...
																								<td data-field="Sno" aria-label="64616-103" class="datatable-cell"><span style="width: 80px;">64616-103</span></td>
																								<td data-field="ShiftName" aria-label="Morning" class="datatable-cell"><span style="width: 80px;">Morning</span></td>
                                                    ...
                                                    <td data-field="Saturday"  aria-label="09-20" class="datatable-cell"><span style="width: 80px;">09-20</span></td>
																								...
																								<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																									<span style="overflow: visible; position: relative; width: 100px;">
																										<a href="editshifts" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
