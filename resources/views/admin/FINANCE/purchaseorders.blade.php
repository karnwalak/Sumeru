								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Purchase Order
										...
										<!-- <a href="createpurchaseorder" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Create Order</a> -->
										</div>
									</div>
									<!--end::Header-->
									<!--begin::Body-->
												...
												<div class="row align-items-center">
													<div class="col-lg-9 col-xl-8">
														<div class="row align-items-center">
															...
															<div class="col-md-4 my-2 my-md-0">
																<div class="row">
																	<label class="col-form-label text-left col-lg-4 col-sm-12">Price</label>
																	<div class="col-lg-8 col-md-8	 col-sm-12" data-select2-id="242">
																		<select class="form-control" id="kt_select2_1" name="param">
																			<option value="AK">Alaska</option>
																			<option value="HI">Hawaii</option>
												...
												<table class="datatable-table" style="display: block;">
													<thead class="datatable-head">
														<tr class="datatable-row" style="left: 0px;">
															...
															<th data-field="Balance" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Balance</span></th>
													...
													<tbody class="datatable-body" style="">
														...
														<tr data-row="0" class="datatable-row" style="left: 0px;">
															...
															<td data-field="SellerName" aria-label="Brazil" class="datatable-cell"><span style="width: 100px;">{{$value -> seller_name}}</span></td>
															<td data-field="SellerContact" aria-label="9876543212" class="datatable-cell"><span style="width: 100px;">{{$value -> seller_contact}}</span></td>
															<td data-field="InvoiceNo" aria-label="#64616" class="datatable-cell"><span style="width: 100px;">{{$value -> invoice_id}}</span></td>
															<td data-field="Amount" aria-label="Rs. 98765" class="datatable-cell"><span style="width: 100px;">Rs. {{$value -> order_amount}}</span></td>
															...
															<td data-field="Status" aria-label="5" class="datatable-cell"><span style="width: 100px;"><span class="label label-lg font-weight-bold label-light-info label-inline">{{$value -> order_status}}</span></span></td>
															<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																<span style="overflow: visible; position: relative; width: 125px;">
																<a href="viewpurchaseorder/{{$value->id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																...
																<a href="editpurchaseorder/{{$value->id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																	<span class="svg-icon svg-icon-md">
																...
																<a href="../ERP/deleteorder/{{$value->id}}" class="btn btn-sm btn-clean btn-icon" title="Delete">
																	<span class="svg-icon svg-icon-md">
																		<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																			<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																				<rect x="0" y="0" width="24" height="24"></rect>
