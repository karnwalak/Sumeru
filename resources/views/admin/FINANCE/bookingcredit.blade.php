							...
							<div class="d-flex flex-column-fluid">
									...
									<div class="container">
											...
											<div class="d-flex align-items-center flex-wrap mr-2">
													<!--begin::Title-->
													<h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5 pl-10 pt-5">Booking Credits</h5>
													<!--end::Title-->
													<!--begin::Separator-->
												...
												<div class="row" style="justify-content:center;">
														...
														<li>
																<div class="col-md-3 col-6" style="padding:20px 0px 20px 20px;">
																		<a onclick="showorders()" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2" id="lnk1" style="width:125px !important;">Pending</a>
																</div>
															</li>
															<li>
																	<div class="col-md-3 col-6" style="padding:20px 0px;">
																			<a onclick="showsellers()" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2" id="lnk2"style="width:125px !important;">Paid</a>
																	</div>
															</li>
														</ul>
												</div>
																				...
																				<table class="datatable-table" style="display: block;">
																					...
																					?>
																						@foreach($data as $value)
																							<?php 
																							$ids = $value -> booking_id;
																							$res= DB::SELECT("SELECT * FROM crm_booking_payment_logs WHERE status='Submitted' AND booking_id = $ids");
																							?>
																						    @if(count($res) < 1)
																							<tr data-row="0" class="datatable-row" style="left: 0px;">
																								...
																								<td data-field="BookingID" aria-label="#45646" class="datatable-cell"><span style="width: 120px;">#{{$value -> booking_id}}</span></td>
																								<td data-field="BookingID" aria-label="#45646" class="datatable-cell"><span style="width: 120px;">{{$value -> status}}</span></td>
																								<td class="datatable-cell nowrap" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																								<a data-id="{{$value -> booking_id}}" class="btn btn-sm btn-clean btn-icon mr-2 check" title="View">
