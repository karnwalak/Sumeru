                                            ...
                                            <div class="card-body p-0">
                                                <div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
                                                    <div class="col-xl-12 col-xxl-10">
                                                      <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Transactions</h5>
                                                                    ...
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="col-xl-6 col-12">
                                                                            ...
                                                                            <input type="hidden" name="tid" value="{{$id}}">
                                                                                    ...
                                                                                    <div class="col-lg-9 col-xl-9">
                                                                                            <input class="form-control form-control-solid form-control-lg" name="amount" type="text" value="" />
                                                                                            <span class="text-danger field_error" id="amount_error"></span>
                                                                                    </div>
                                                                            </div>
                                                                        </div>
                                                                        <!--end::Group-->
                                                                        ...
                                                                        <div class="col-xl-6 col-12">
                                                                            <div class="form-group row" data-select2-id="243">
                                                                                    <label class="col-form-label text-left col-lg-4 col-sm-12">Transaction Type</label>
                                                                            ...
                                                                            <div class="form-group row">
                                                                                    ...
                                                                                    <div class="col-lg-8 col-xl-8">
                                                                                         <div class="input-group input-group-solid input-group-lg">
                                                                                            <input type="date" class="form-control form-control-solid form-control-lg" name="date" placeholder="Username" value="Rs." />
                                                                                            <div class="input-group-append">
                                                                                            </div>
                                                                                        </div>
                                                                                        <span class="text-danger field_error" id="date_error"></span>
                                                                                    </div>
                                                                            </div>
                                                                        </div>
                                                                        <!--end::Group-->
                                                                    ...
                                                                    <table class="datatable-table" style="display: block;">
                                                                            <thead class="datatable-head">
                                                                                <tr class="datatable-row" style="left: 0px;">
                                                                                    ...
                                                                                    <th data-field="Amount" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Si No</span></th>
                                                                                    ...
                                                                                    <th data-field="Method" class="datatable-cell datatable-cell-sort"><span style="width: 100px;">Method</span></th>
                                                                            ...
                                                                            <tbody class="datatable-body" style="">
                                                                                ...
                                                                                <tr data-row="0" class="datatable-row" style="left: 0px;">
                                                                                    ...
                                                                                    <td data-field="Amount" aria-label="Rs. 30000" class="datatable-cell"><span style="width: 100px;">{{$a++}}</span></td>
                                                                                    <td data-field="Amount" aria-label="Rs. 30000" class="datatable-cell"><span style="width: 100px;">Rs. {{$value -> txn_amount}}</span></td>
                                                                                    <td data-field="Type" aria-label="Cash" class="datatable-cell"><span style="width: 100px;">{{$value -> txn_method}}</span></td>
                                                                                    <td data-field="Date" aria-label="26/12/2021" class="datatable-cell"><span style="width: 80px;">{{$value -> txn_date}}</span></td>
                                                                                    <td data-field="Method" aria-label="Online" class="datatable-cell"><span style="width: 100px;">{{$value -> txn_amount}}</span></td>
