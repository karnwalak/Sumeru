								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">View Purchase Order</h3>
									...
									<div class="row">
										...
										<div class="col-md-3" style="margin:10px;margin-top:16px;" >
											...
											<div class="form-group row" data-select2-id="243" style="margin-bottom:0px !important">
													<label class="col-xl-6 col-lg-6 col-form-label" id="head">Seller Name</label>
												<div class="col-lg-6 col-md-6 col-sm-6" data-select2-id="242">
													<input type="text" class="form-control" value="{{$value -> seller_name}}" readonly>
												</div>
											</div>
											<!--end::Group-->
											</div>
										...
										<div class="col-md-3" style="margin:10px" >
											<div class="row">
													...
													<div class="col-lg-6 col-xl-6">
														<input class="form-control form-control-solid form-control-lg" name="lastname" readonly type="text" value="{{$value -> invoice_id}}" />
													</input>
													</div>
											</div>
										</div>
										<div class="col-md-4"  style="margin:10px">
											<div class="row">
													...
													<div class="col-lg-6 col-xl-6">
														<input class="form-control form-control-solid form-control-lg" readonly name="lastname" type="text" value="{{$value -> date}}"  id="dateinput" />
													</input>
													</div>
											</div>
										</div>
    ...
    <div class="row">
		<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12" >
					...
					<tbody>
						...
						<tr>
							<td><input type="text" name="quantity[]" id="quantity" value="{{$mat -> material_name}}" readonly class="form-control quantity" autocomplete="off"></td>
							<td><input type="number" name="quantity[]" id="quantity" value="{{$mat -> material_quantity}}" readonly class="form-control quantity" autocomplete="off"></td>
							<td><input type="text" class="form-control" readonly value="{{$mat -> type}}"></td>			
                            <td><input type="number" name="price[]" id="price" readonly value="{{$mat -> material_price}}" class="form-control price" autocomplete="off"></td>
							<td><input disabled type="number" name="amount[]" id="amount" value="{{$mat -> material_price * $mat -> material_quantity}}" class="form-control amount" autocomplete="off"></td>
							<!-- <td><a href="#" class="btn btn-danger remove" style="">-</button></a></td> -->
						</tr>
						<?php $sum = $sum+($mat -> material_quantity*$mat -> material_price);?>
						@endforeach
					</tbody>
					<tfoot>
								<tr>
										...
										<td style="border: none"></td>
										<td>Total</td>
										<td><b class="total"><?php echo $sum; ?></b> </td>
						<!-- <td></td> -->
		...
		<div class="col-md-5" style="margin:10px">
			...
			<div class="form-group row">
					<label>Comment</label>
						<input class="form-control form-control-solid form-control-lg" readonly name="lastname" type="text" value="{{$value -> comment}}" />
					</input>
			</div>
		</div>
		...
		<div class="col-md-5" style="margin:10px;">
			<div class="form-group row">
				<label>Sub-Total</label>
					<input class="form-control form-control-solid form-control-lg" readonly name="lastname" type="text" value="{{$sum}}" />
				</input>
			</div>
			<div class="form-group row">
					<label>Discount</label>
						<input class="form-control form-control-solid form-control-lg" readonly name="lastname" type="text" value="{{$value -> discount}}" />
					</input>
			</div>
			<div class="form-group row">
					<label>Total</label>
						<input class="form-control form-control-solid form-control-lg" readonly name="lastname" type="text" value="{{$value -> order_amount}}" />
					</input>
			</div>
		</div>
		<div class="col-md-1"></div>
...
@include('admin/usersidebar')	<!--begin::Scrolltop-->
   ...
   $('tbody').delegate('.quantity,.price','keyup',function(){
        var htmlRows=$(this).parent().parent();
        var quantity=htmlRows.find('.quantity').val();
        var price=htmlRows.find('.price').val();
        var amount=(quantity*price);
        htmlRows.find('.amount').val(amount);
        total();
    });
	...
	//alert('hr');
		...
		htmlRows +='<td><select id="productName" name="material_name[]" class="form-control">'+material_id_html+'</select></td>';
		...
		htmlRows +='<td><select id="type_id" name="type[]" class="form-control">'+type_id_html+'</select></td>';
		
		htmlRows += '<td><input type="number" name="price[]" id="price" class="form-control price" autocomplete="off"></td>';		 
		htmlRows += '<td><input type="number" name="amount[]" id="amount" class="form-control amount " autocomplete="off" disabled></td>';          
