				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="d-flex flex-column-fluid">
							...
							<div class="row justify-content-center">
									...
									<div class="col-md-6 alert alert-success alert-block alert-dismissible fade show">  
										<span>{{ $message }}</span>
								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Flat inventory</h3>
										</div>
										<div class="row" style="display:grid;place-items:end;padding:10px 15px;">
													<ul class="nav nav-light-success nav-pills" id="myTab" role="tablist">
															<li><a href="addflats" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add Flats</a></li>
															<li><a href="flatstockcategory" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Stock Category</a></li>
													</ul>
												</div>
									</div>
									<!--end::Header-->
																...
																<tr data-row="0" class="datatable-row" style="left: 0px;">
																	...
																	<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																		...
																		<a href="editflats/{{$value -> id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																				...
																				<a href="deleteflat/{{$value -> id}}" class="btn btn-sm btn-clean btn-icon" onclick="return confirm('Are you sure?');" title="Delete">
																					<span class="svg-icon svg-icon-md">
																						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																								<rect x="0" y="0" width="24" height="24"></rect>
