...
// $data = Flat::orderBy('id')->paginate(10);
?>
<!DOCTYPE html>
<html lang="en">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										...
										<div class="row" style="display:grid;place-items:end;padding:10px 15px;">
													<ul class="nav nav-light-success nav-pills" id="myTab" role="tablist">
															<li><a href="../FLAT/flatstockinventory" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Back</a></li>
													</ul>
												</div>
									</div>
									<!--end::Header-->
									...
									<div class="card-body">
											...
											<div class="card card-custom gutter-b">
												<div class="card-body">
													<!--begin: Search Form-->
													<!--begin::Search Form-->
													<!-- <form method="post" action="searchflat">
														{{@csrf_field()}}
													<div class="mb-7">
																...
																<div class="row align-items-center">
																	<div class="col-md-4 my-2 my-md-0">
																		<div class="input-icon">
																			<input type="text" class="form-control" placeholder="Search..." name="stockname" id="kt_datatable_search_query">
																			<span>
														...
														<table class="datatable-table" style="display: block;">
															<thead class="datatable-head">
																<tr class="datatable-row" style="left: 0px;">
																	...
																	<th data-field="Price" class="datatable-cell datatable-cell-sort"><span style="width: 140px;">Price</span></th>
																	<th data-field="Status" class="datatable-cell datatable-cell-sort"><span style="width: 140px;">Status</span></th>
															...
															<tbody class="datatable-body" style="">
																...
																<tr data-row="0" class="datatable-row" style="left: 0px;">
																	...
																	<td data-field="Sno" aria-label="{{$a++}}" class="datatable-cell"><span style="width: 140px;">{{$a++}}</span></td>
																	...
																	<td data-field="{{$value -> flat_category_id}}" aria-label="{{$value -> flat_category_id}}" class="datatable-cell"><span style="width: 140px;">{{$value -> flat_category_id}}</span></td>
																	...
																	<td data-field="Status" aria-label="" class="datatable-cell"><span style="width: 140px; margin-left: 40px;">
																	...
																	<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																		...
																		<a href="editflats/{{$value -> id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																				...
																				<a href="deleteflat/{{$value -> id}}" onclick="return confirm('Are you sure?');" class="btn btn-sm btn-clean btn-icon" title="Delete">
																					<span class="svg-icon svg-icon-md">
																						<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																							<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																								<rect x="0" y="0" width="24" height="24"></rect>
