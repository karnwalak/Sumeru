								...
								<div class="card card-custom">
									...
									<div class="card-header flex-wrap border-0 pt-6 pb-0">
										<div class="card-title">
											<h3 class="card-label">Flat Stock Category</h3>
										</div>
										<div class="row" style="display:grid;place-items:end;padding:10px 15px;">
												<a href="addflatstockcategory" class="btn btn-light-primary font-weight-bold btn-sm px-4 font-size-base ml-2">Add Stock Category</a>
												</div>
									</div>
									<!--end::Header-->
									<!--begin::Body-->
									<div class="card-body">
											...
											<div class="card card-custom gutter-b">
												<div class="card-body">
													<!--begin: Search Form-->
													<!--begin::Search Form-->
														<form method="post" action="../FLAT/searchflatcategory">
															{{@csrf_field()}}
													<div class="mb-7">
																...
																<div class="row align-items-center">
																	<div class="col-md-3 my-2 my-md-0">
																		<div class="input-icon">
																			<input type="text" class="form-control" placeholder="Search..." name="category" id="kt_datatable_search_query">
																			<span>
																	...
																	<!-- <div class="col-md-5 my-2 my-md-0">
																		<div class="row">
																			<label class="col-form-label text-left col-lg-4 col-sm-12">Category</label>
																			<div class="col-lg-8 col-md-8	 col-sm-12" data-select2-id="242">
															...
															<tbody class="datatable-body" style="">
																...
																<tr data-row="0" class="datatable-row" style="left: 0px;">
																	...
																	<td class="datatable-cell-left datatable-cell" data-field="Actions" data-autohide-disabled="false" aria-label="null">
																		...
																		<a href="editflatstockcategory/{{$value -> id}}" class="btn btn-sm btn-clean btn-icon mr-2" title="Edit details">
																		...
																		<a href="deleteflatcategory/{{$value -> id}}" onclick="return confirm('Are you sure?');" class="btn btn-sm btn-clean btn-icon" title="Delete">
																			<span class="svg-icon svg-icon-md">
																				<svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
																					<g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
																						<rect x="0" y="0" width="24" height="24"></rect>
																...
																@endforeach
																@else
																 <tr><td><h3>No data found!</h3></td></tr>
																@endif
															</tbody>
														</table>
