									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-0">
													<a href="flatdashboard" class="text-dark font-weight-bold text-hover-primary font-size-h4">Inventory Management</a>
												</div>
												<!--end::Name-->
											</div>
											<!--end::Body-->
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-0">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">Sales Management</a>
												</div>
												<!--end::Name-->
											</div>
											<!--end::Body-->
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-0">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">Financial Management</a>
												</div>
												<!--end::Name-->
											</div>
											<!--end::Body-->
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-0">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">HR & Payroll Management</a>
												</div>
												<!--end::Name-->
											</div>
											<!--end::Body-->
									...
									<div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
										<div class="card card-custom card-stretch gutter-b">
											...
											<div class="card-body text-center pt-4">
												...
												<!--begin::Name-->
												<div class="my-0">
													<a href="#" class="text-dark font-weight-bold text-hover-primary font-size-h4">Projtect Management</a>
												</div>
												<!--end::Name-->
											</div>
											<!--end::Body-->
