						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<!-- <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Edit Flats Stock Category</h5> -->
									<!--end::Title-->
									<!--begin::Separator-->
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row" data-select2-id="243">
																				...
																				<div class="col-lg-9 col-md-9 col-sm-12" data-select2-id="242">
																					<input type="hidden" name="ca_id" value="{{$value -> id}}">
															    ...
															    <?php
																    function categoryTree($rowid, $category){
																      ...
																      foreach ($data as $value) {
																        ...
																        $cat_id = $value -> id;
																       ?>
																      <option value="<?php echo $cat_id; ?>" selected><?php echo $concat; ?></option>
																      <?php
