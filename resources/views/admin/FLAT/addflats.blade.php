	...
	<div class="d-flex flex-column flex-root">
		...
		<div class="d-flex flex-row flex-column-fluid page">
				...
				<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<!-- <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Flats</h5> -->
									<!--end::Title-->
									<!--begin::Separator-->
									<div class="subheader-separator subheader-separator-ver mt-2 mb-2 mr-5 bg-gray-200"></div>
									<!--end::Separator-->
												...
												<div class="card-body p-0">
													<div class="row justify-content-center py-8 px-8 py-lg-15 px-lg-10">
														...
														<div class="row" style="justify-content:end;">
															<!-- <a href="flatstockinventory" class="btn btn-default font-weight-bold btn-sm px-3 font-size-base">Back</a> -->
														</div>
															<!--begin::Wizard Form-->
			...
			<div class="card-title col-md-6">
				<h3 class="card-label">Add Flats</h3>
			</div>
																	...
																	<div class="col-xl-9">
																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row">
																				<label class="col-xl-3 col-lg-3 col-form-label">Stock Name</label>
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" name="stockname" type="text" value="" />
																					<span style="color:red;" id="stockname_error" class="field_error"></span>
																				</div>
																			</div>
																			<!--end::Group-->
																			<!--begin::Group-->
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" name="price" type="text" value="" />
																					<span style="color:red;" id="price_error" class="field_error"></span>
																				</input>
																				</div>
																			</div>
																			<!--end::Group-->
