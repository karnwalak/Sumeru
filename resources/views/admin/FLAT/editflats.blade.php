																		...
																		<div class="my-5 step" data-wizard-type="step-content" data-wizard-state="current">
																			...
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input type="hidden" name="flat_id" value="{{$val -> id}}">
																					<input class="form-control form-control-solid form-control-lg" name="stockname" type="text" value="{{$val -> flat_stock_name}}" />
																			...
																			<div class="form-group row">
																				...
																				<div class="col-lg-9 col-xl-9">
																					<input class="form-control form-control-solid form-control-lg" name="price" type="text" value="{{$val -> flat_price}}" />
