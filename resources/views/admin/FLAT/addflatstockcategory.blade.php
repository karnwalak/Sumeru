...
<body id="kt_body" class="header-fixed header-mobile-fixed subheader-enabled page-loading">
						...
						<div class="subheader py-2 py-lg-4 subheader-transparent" id="kt_subheader">
							<div class="container d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
								...
								<div class="d-flex align-items-center flex-wrap mr-2">
									<!--begin::Title-->
									<!-- <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Add Flats Stock Category</h5> -->
									<!--end::Title-->
									<!--begin::Separator-->
														...
														<div class="row" style="justify-content:end;">
															...
															<form class="form" id="kt_form">
																...
																<div class="row justify-content-center d-flex py-5">
																	<div class="card-title col-md-6">
																		<h3 class="card-label">Add Flat Stock Category</h3>
																	</div>
															...
															<div class="form-group row" data-select2-id="243">
															    ...
															    <?php
																    function categoryTree($rowid, $category){
																      $data = DB::SELECT("SELECT * FROM flat_categories WHERE category_parent=$rowid");
															    ...
															    ?>
																	<select class="form-control" id="kt_select2_1" name="parent_category">
																		<option value="">Select</option>
																		<option value="0">Parent Category</option>
																		 <?php 
																		     $datas = DB::SELECT("SELECT * FROM flat_categories WHERE category_parent=0");
																	...
																	<span style="color:red;" class="field_error" id="parent_category_error"></span>
																</div>
															</div>
															<!--end::Group-->
															<!-- begin::Group -->
															<div class="form-group row" data-select2-id="243">
																...
																<div class="col-lg-9 col-md-9 col-sm-12" data-select2-id="242">
																	...
																	<span style="color:red;" class="field_error" id="status_error"></span>
																</div>
															</div>
															<!--end::Group-->
																		</div>
																	...
																	<!-- 	<div class="d-flex justify-content-between border-top pt-10 mt-15">
																		...
																		<!--end::Wizard Actions-->
																		<div class="row" style="display:grid;place-items:end;"><button type="submit" class="btn btn-primary font-weight-bold btn-sm px-3 font-size-base">Submit</button>
																		</div>
    ...
    <script type="text/javascript">
        ...
        $(".form").submit(function(e){
          ...
          $('.field_error').html('');
          $.ajax({
            url:'../admin/FLAT/addFlatCategory',
            data:$(".form").serialize(),
            type:'post',
